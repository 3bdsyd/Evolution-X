...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<SvgGenImage> get values => [arrowBack, eye, password, user];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/logo_.png
  AssetGenImage get logoPng_ => const AssetGenImage('assets/images/logo_.png');

  /// List of all assets
  List<AssetGenImage> get values => [logoPng, logoPng_];
}
