...
// import 'package:your_reservation/core/helper/failures_handling.dart';
// import 'package:your_reservation/core/localization/language_service.dart';
// import 'package:your_reservation/core/services/app_services.dart';
// import 'package:your_reservation/core/utils/constants/app_key.dart';
...
//       if (_box.read(AppKey.verify) == 'true'||(_box.read(AppKey.token) != null && url == 'https://7ajzacom.com/api/patient/verify')) {
//         _dio.options.headers["Authorization"] =
//             "Bearer ${_box.read(AppKey.token)}";
//       }
